...
/*
 * Pi::service('api')->contact(array('Text', 'keywords'), $keywords);
 * Pi::service('api')->contact(array('Text', 'description'), $description);
 * Pi::service('api')->contact(array('Text', 'alias'), $alias, $id, $model);
 */
